...
# ---------------------------------------------------------------------------
# 2. Load native Moshi model (NOT AutoModelForCausalLM)
# ---------------------------------------------------------------------------
print("\n[2/6] Loading native Moshi model...")
from moshi.models import loaders, lm

# Download / locate checkpoint
checkpoint_path = loaders._get_checkpoint(MOSHI_REPO_ID, "model.safetensors", CACHE_DIR)
print(f"    Checkpoint: {checkpoint_path}")

# Load model weights
state_dict = loaders.load_model(checkpoint_path, device=DEVICE)
