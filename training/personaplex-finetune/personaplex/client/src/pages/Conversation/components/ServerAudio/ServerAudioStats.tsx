    ...
    <div className="w-full rounded-lg text-zinc-500 p-2">
      ...
      <table>
        <tbody>
          ...
          <tr>
            <td className="text-md pr-2">RTF: </td>
            <td>{(() => {
              const wallSecs = (Date.now() - startWallTime.current) / 1000;
              return wallSecs > 0.5 ? (audioStats.playedAudioDuration / wallSecs).toFixed(2) + "x" : "—";
            })()}</td>
          </tr>
          <tr>
