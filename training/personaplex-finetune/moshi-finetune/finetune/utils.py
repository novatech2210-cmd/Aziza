...
class TrainState:
    ...
    this_real_token_eval_loss: float | None = None
    this_pad_token_eval_loss: float | None = None
    this_eval_real_token_pct: float | None = None
    this_eval_pred_pad_pct: float | None = None
