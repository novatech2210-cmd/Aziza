...
def generate_shard(args, dialogues, voice_assignments):
    ...
    from vibevoice.modular.modeling_vibevoice_streaming_inference import VibeVoiceStreamingForConditionalGenerationInference as VibeVoiceForConditionalGeneration
    from vibevoice.processor.vibevoice_streaming_processor import VibeVoiceStreamingProcessor as VibeVoiceProcessor
